 ...
 * меньше или равно down или больше или равно up. Ваша задача найти
 * все аномалии в массиве. Если в аномалии одно, число то нужно вернуть
 * диапазон [i, i] - где i индекс числа выходящего за границы.
 * Например,
 * <p>
