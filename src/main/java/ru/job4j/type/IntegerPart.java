...
Иногда бывает нужным, что получить целую часть числа вещественного числа. Заметьте не округлить в сторону целого, а получить целую часть, т.е если есть число 2.9, нам нужно получить 2.
