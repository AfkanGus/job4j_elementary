...
* Ваша задача создать новую строку, в которой будут в
* символы исходной в верхнем регистре. Если символ не
* является буквой, например цифры или -, то просто записать
* в результат.
