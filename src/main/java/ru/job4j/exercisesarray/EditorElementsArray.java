...
public class EditorElementsArray {
    public static int[][] changeDate(int[][] array, int el) {
...
*  число элементов в ряду. Необходимо перебрать массив и сравнить
* каждый элемент со значением el которое мы передаем в параметрах метода.
* При этом:
...
2. Если элемент массива меньше или равен el - необходимо заменить текущий
* элемент массива 0.
* */