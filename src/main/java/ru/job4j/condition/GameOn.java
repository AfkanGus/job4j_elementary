...
* превышает цену игры, метод вернул
* разницу между этими величинами (т.е. чистую прибыль), или вернул 0 (при условии что читая прибыль меньше или равна 0).
* */
public class GameOn {
    public static int checkGameOn(double percent, int prize, int pay) {
